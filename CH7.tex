...
\noindent The last plot (figure \ref{fig:corr3}) shows the full scatter matrix of the various distances from the 19 genres. The main diagonal shows the histograms of the distances from the belonging unique feature-sets.
