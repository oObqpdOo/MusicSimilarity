...
In chapter \ref{rhythmsimc} an attempt to extract note information as text features from chromagrams and calculating the similarity by using the levinshtein distance is shown and evaluated.
