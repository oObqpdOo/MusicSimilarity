...
\end{figure}
\FloatBarrier
\noindent To describe a tone, three moments can be used according to \cite[pp. 15]{musicdata}: %tonal intensity perceived as loudness, the tonal quality perceived as the pitch and the timbre or tonal color as the third moment. 
\begin{itemize}
...
\begin{figure}[htbp]
	...
	\caption{MFCCs mean and standard deviation (guitar vs. piano)}	
