...
These differences could be explained with the choice of only 13 Mel-bands during the computation of the MFCCs in this thesis compared to the 25 bands in Musly~\cite{musly1} and some other decisions like omitting the normalization with mutual proximity (Section~\ref{mprox}). The same goes for the Jensen-Shannon-like divergence. 
