...
\subsubsection{Performance Comparison of RDD vs DataFrame}
...
\subsection{feature separation quality}
...
\begin{figure}[htbp]
	\centering
	\framebox{\parbox{1\textwidth}{ 			
			\includegraphics[scale=0.5]{Images/SparkFeat/scatter100_1classicsong.png}	
	}}
